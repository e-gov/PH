CONFIG = {
   ...
   'errors': {
       ...
       'delegate_not_found': {
            ...
            'title': 'Delegate was not found',
            'translation': {
                 'en': 'Delegate was not found',
                 'et': 'Volituse kustutamine ebaõnnestus',
                 'ru': 'Volituse kustutamine ebaõnnestus (ru)'
            },
            'type': 'test-type-for-delegate-not-found'
       },
