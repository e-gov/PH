...
public interface RolesApi {
    ...
    @Operation(summary = "List roles with translations", description = "When 'If-Modified-Since' is included in the request the service responds HTTP Status code 304 if nor roles have been changed since that time. Otherwise all results (that match the filters) are returned (even the ones that have modified time earlier than If-Modified-Since parameter). ", tags={ "Kõik teenused", "Pääsukese poolt pakutav", "Pääsukesele pakutav" })
    @ApiResponses(value = { 
